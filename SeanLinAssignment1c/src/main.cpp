...
void makeImage(ImgSettings settings){
    ...
    makeObjects(settings, cam, img, objects, vertices, normals, uvs, polygons, materials, textures, lights);
    ...
    render(img, cam, objects, vertices, normals, uvs, polygons, materials, textures, lights, outputFile);
...
void render(Image &img, Camera &cam, 
        vector<Object*> &obj, vector<Vertex*> &vert, vector<Normal*> &norm, vector<UvCoord*> &uvs, vector<Polygon*> &poly, 
        vector<Material*> &mtl, vector<Texture *> tex, vector<Light*> &lt, ofstream &file){
